...
export default function Page() {
  const [teams, setTeams] = useState<Team[]>([
    ...
    // As of 260324, Matt, Eric, and Michelle are the only ones who should be excluded
    // As of 260923, force Phil to be selected today. Random nexxt time and Mike the next.
    // Interviee's that have actually been selected: Ryan C, Mellanie R, Justin B, Taylor K, Sara W, Mickala W, Joe L, Scott V, Jami M, Bruce B, Elle L, Chris R
  ...
  return (
    <main className="app">
        <div className="titleRow">
            <h1 className="title">Carmel Conversations</h1>
        </div>
        <div className="grid">
