...
export default function Page() {
  const [teams, setTeams] = useState<Team[]>([
    ...
    // Interviee's that have actually been selected: Ryan C, Mellanie R, Justin B, Taylor K, Sara W, Mickala W, Joe L, Scott V, Jami M, Bruce B, Elle L
  ...
  return (
    <main className="app">
        ...
        <div style={{ display: 'flex', justifyContent: 'center', marginTop: 10, flexDirection: 'column', alignItems: 'center', gap: 0, lineHeight: 2}}>
            <p style={{ margin: 0 }}>Eligible 10/1: Mary Jo Adams, Andrew Burker, Cody Burker</p>
        </div>
    </main>
  );
}
